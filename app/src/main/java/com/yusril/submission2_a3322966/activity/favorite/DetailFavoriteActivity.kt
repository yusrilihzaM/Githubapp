...
import com.yusril.submission2_a3322966.activity.detail.SectionsPagerAdapter
...
class DetailFavoriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val user=intent.getParcelableExtra<UserFavorite>(DetailUserActivity.EXTRA_USER) as UserFavorite
